...
public protocol RockPaperScissorsScreenModuleOutput: AnyObject {}

/// События которые отправляем из `другого модуля` в `текущий модуль`
public protocol RockPaperScissorsScreenModuleInput {
...
public typealias RockPaperScissorsScreenModule = UIViewController & RockPaperScissorsScreenModuleInput
