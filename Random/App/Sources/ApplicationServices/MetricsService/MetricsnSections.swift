...
enum MetricsSections: String {
  ...
  case joke = "Раздел Анекдотов (new version)"
  case gifts = "Раздел Подарков (new version)"
  case slogans = "Раздел Слоганов (new version)"
  case quotes = "Раздел Цитат (new version)"
