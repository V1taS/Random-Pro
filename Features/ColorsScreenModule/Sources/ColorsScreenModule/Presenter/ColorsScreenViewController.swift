...
public protocol ColorsScreenModuleOutput: AnyObject {
...
public protocol ColorsScreenModuleInput {
...
public typealias ColorsScreenModule = UIViewController & ColorsScreenModuleInput
