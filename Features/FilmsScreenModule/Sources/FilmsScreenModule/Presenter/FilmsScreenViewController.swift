...
public protocol FilmsScreenModuleOutput: AnyObject {
...
public protocol FilmsScreenModuleInput {
...
public typealias FilmsScreenModule = UIViewController & FilmsScreenModuleInput
