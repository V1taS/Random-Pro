...
public final class AuthenticationServiceImpl: AuthenticationService {
  ...
  public func sendUserVerificationEmail(completion: @escaping (Result<Void, Error>) -> Void) {
  ...
  public func updateUserProfileWith(model: AuthenticationServiceFirebaseModel,
                                    completion: @escaping (Result<Void, Error>) -> Void) {
  ...
  public func getUserProfile(completion: @escaping (AuthenticationServiceFirebaseModel?) -> Void) {
    let user = Auth.auth().currentUser
    guard let user else {
      DispatchQueue.main.async {
        completion(nil)
  ...
  public func checkIsSignedFirebase(completion: @escaping (_ isSigned: Bool) -> Void) {
    DispatchQueue.main.async {
  ...
  public func signOutFirebaseWith(completion: @escaping (Result<Void, Error>) -> Void) {
    DispatchQueue.main.async {
  ...
  public func authFirebaseWith(idTokenString: String,
                               nonce: String,
                               completion: @escaping (Result<AuthenticationServiceFirebaseModel, Error>) -> Void) {
  ...
  public func getIsRegistered(forUserID: String, completion: @escaping (Bool) -> Void) {
    let appleIDProvider = ASAuthorizationAppleIDProvider()
