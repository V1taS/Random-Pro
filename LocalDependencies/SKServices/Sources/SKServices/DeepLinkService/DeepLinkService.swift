...
public final class DeepLinkServiceImpl: DeepLinkService {
  public init() {}
  ...
  public var dynamicLinkType: DynamicLinkType? {
    get {
  ...
  public func eventHandlingWith(deepLimkURL: URL?) {
  ...
  public func parseDynamicLink(_ url: URL?, completion: ((DynamicLinkType) -> Void)?) {
  ...
  public func parseComponents(_ components: URLComponents?, completion: ((DynamicLinkType) -> Void)?) {
    // Извлекаем userID
