...
final class MainScreenCoordinator: MainScreenCoordinatorProtocol {
  ...
  func start() {
    let mainScreenModule = MainScreenAssembly().createModule(featureToggleServices: services.featureToggleServices,
                                                             storageService: services.storageService,
                                                             appPurchasesService: services.appPurchasesService)
...
//    services.metricsService.track(event: .premiumScreen)
  ...
  func showScreenDeepLinkWith(type deepLinkType: DeepLinkTypeProtocol) {
