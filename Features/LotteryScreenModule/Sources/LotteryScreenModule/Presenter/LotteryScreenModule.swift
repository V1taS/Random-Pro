...
public protocol LotteryScreenModuleOutput: AnyObject {
...
public protocol LotteryScreenModuleInput {
...
public typealias LotteryScreenModule = UIViewController & LotteryScreenModuleInput
