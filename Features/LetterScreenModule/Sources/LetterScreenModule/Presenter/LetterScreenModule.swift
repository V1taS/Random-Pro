...
public protocol LetterScreenModuleOutput: AnyObject {
...
public protocol LetterScreenModuleInput {
...
public typealias LetterScreenModule = UIViewController & LetterScreenModuleInput
