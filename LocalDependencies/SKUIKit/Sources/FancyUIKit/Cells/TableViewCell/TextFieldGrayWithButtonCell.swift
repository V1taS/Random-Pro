//
//  TextFieldGrayWithButtonCell.swift
//  
//
...
public final class TextFieldGrayWithButtonCell: UITableViewCell {
  
  // MARK: - Public property
  
  /// Identifier для ячейки
  public static let reuseIdentifier = TextFieldGrayWithButtonCell.description()
  ...
  private func configureLayout(textField: TextFieldView) {
    ...
    NSLayoutConstraint.activate([
      ...
      buttonImageView.leadingAnchor.constraint(equalTo: textField.trailingAnchor,
                                               constant: appearance.insets.left / 4),
...
private extension TextFieldGrayWithButtonCell {
  struct Appearance {
